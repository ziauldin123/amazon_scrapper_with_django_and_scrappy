...
class Scraper():
    ...
    def check_page_validity(self, page_content):
        ...
        print('page validity!', valid_page)
        return valid_page
    ...
    def get_product_url(self, product):
        ...
        return base_url + "/dp/" + product.get('data-asin')
    ...
    def get_product_info(self, product):
        ...
        # print('product list',self.product_obj_list)
    ...
    def get_products(self, page_content):
        ...
        print('asin',product_list[0].get('data-asin'))
        for product in product_list:
            self.get_product_info(product)
            print('asin',product.xpath('@data-asin').extract_first())
