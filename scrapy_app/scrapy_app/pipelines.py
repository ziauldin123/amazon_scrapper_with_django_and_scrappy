...
from main.models import ScrapyItem, Product
...
class ScrapyAppPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        scrapy_item.product_name = item['title']
        scrapy_item.market = item['contents']
        scrapy_item.main_image = item['published_date']
